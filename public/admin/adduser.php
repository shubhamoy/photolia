...
<div class="container">
	...
	<form action="" name="addUser" method="post"> 
		<input class="form-control" type="text" name="username" placeholder="Enter the username">
		&nbsp;
		<input class="form-control" type="text" name="password" placeholder="Enter the password">		
		&nbsp;
		<input class="form-control" type="text" name="fname" placeholder="Enter the first name">		
		&nbsp;		
		<input class="form-control" type="text" name="lname" placeholder="Enter the last name">		
		&nbsp;		
		<button type="submit" name="add" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add</button>
	</form> 
</div>
<footer class="footer">
<div class="container">
