...
<body>
<h1 class="text-center">Edit Pic</h1>
...
<div class="container">
	<?=$msg;?>
	<p class="text-center">
		<img class="img-thumbnail" src="<?=$file;?>" style="width:256px;height:256px;">
	</p>
	<form action="" name="editPic" method="post"> 
		<input type="hidden" name="id" value="<?=$id;?>">
		<div class="form-group">
			<label>Caption</label>
			<input class="form-control" type="text" name="caption" placeholder="Enter the Caption" value="<?=$caption;?>">		
		</div>
